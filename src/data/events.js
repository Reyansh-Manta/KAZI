...
• Time constraints must be respected.` },
  { id: 3, title: 'IRIDESCENT', community: 'Binary Minds', head: 'Technical', region: 'Mumbai', collab: 'Kolkata, Chennai, Bengaluru', requiresSubmission: true, time: '6:00 PM', date: '9 Aug', description: `Welcome to IRIDESCENT: Let the ideas flow, an Ideathon hosted by Binary Minds! An Ideathon is an intensive brainstorming event where creative minds gather to tackle pressing real-world challenges through innovative thinking. It’s not just about writing code or building physical prototypes—it's about conceptualizing groundbreaking solutions, validating their feasibility, and pitching them effectively. Whether your idea involves software, hardware, or a completely novel conceptual framework, this is your platform to bring your best ideas to the table and show how they can make a true impact.
...
<table border="1" style="width:100%; border-collapse: collapse; margin-top: 10px; margin-bottom: 10px;">
  ...
  { id: 4, title: 'Photopia', community: 'Snap Sphere', head: 'Photography', region: 'Lucknow', collab: 'Chandigarh', requiresSubmission: true, time: '7:00 PM', date: '8 Aug', description: 'Capture the essence of the event at Photopia. Show off your photography skills and creative eye in this visual storytelling competition by Snap Sphere. Bring your camera or smartphone, find the perfect angle, and tell a compelling story through your lens.' },
  ...
  { id: 7, title: 'Free Fire', community: 'Booyah Brigade', head: 'Free Fire', region: 'Chennai', collab: 'Bengaluru', time: '9:00 PM', date: '9 Aug', description: `Drop into the battleground and prove your survival skills in this high-stakes Free Fire tournament hosted by the Booyah Brigade. Coordinate with your squad, secure the best loot, and outlast the competition to claim the ultimate Booyah.
